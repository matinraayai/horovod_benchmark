"""
# Single GPU equivalent of the Horovod Synthetic Benchmark for Tensorflow.
...
# Benchmark settings
parser = argparse.ArgumentParser(description='TensorFlow 2 Single-GPU Synthetic Benchmark'
                                             'for VGG-16.',
