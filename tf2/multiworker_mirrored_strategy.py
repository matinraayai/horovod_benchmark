...
parser.add_argument('--strategy', default='mirrored',
                    choices=['mirrored', 'multiworker-mirrored'],
...
elif args.strategy == 'multiworker-mirrored':
...
with strategy.scope():
    ...
    @param loss of the step in a single replica
    """
    ...
    for epoch in range(args.num_epochs):
        ...
        for dataset_inputs in train_dataset:
            ...
            print('Current forward pass speed per device: %.3f img/sec.' 
                  % (args.batch_size_per_replica / time))
